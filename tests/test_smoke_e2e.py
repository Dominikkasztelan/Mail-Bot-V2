...
def test_interia_form_selectors_are_valid(page: Page):
    ...
    expect(bot.input_name).to_be_visible(timeout=10000)
    expect(bot.input_surname).to_be_visible(timeout=10000)
    expect(bot.input_login).to_be_visible(timeout=10000)
    expect(bot.input_password).to_be_visible(timeout=10000)
